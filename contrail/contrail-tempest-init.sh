...
#PUBLIC_NETWORK_RI_FQ_NAME="default-domain:admin:$PUBLIC_NETWORK_NAME:$PUBLIC_NETWORK_NAME"
#PUBLIC_NETWORK_RT="10003"
#ROUTER_ASN="64510"
#API_SERVER_IP="10.204.217.22"
#API_SERVER_HOST_USER="admin"
#API_SERVER_HOST_PASSWORD="c0ntrail123"
