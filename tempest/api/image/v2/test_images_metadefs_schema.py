...
class MetadataSchemaTest(base.BaseV2ImageTest):
    ...
    def setup_clients(cls):
        super(MetadataSchemaTest, cls).setup_clients()
    ...
    def test_get_metadata_namespace_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/namespace")
    ...
    def test_get_metadata_namespaces_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/namespaces")
    ...
    def test_get_metadata_resource_type_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/resource_type")
    ...
    def test_get_metadata_resources_types_schema(self):
        ...
        body = self.reader_schemas_client.show_schema(
    ...
    def test_get_metadata_object_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/object")
    ...
    def test_get_metadata_objects_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/objects")
    ...
    def test_get_metadata_property_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/property")
    ...
    def test_get_metadata_properties_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/properties")
    ...
    def test_get_metadata_tag_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/tag")
    ...
    def test_get_metadata_tags_schema(self):
        ...
        body = self.reader_schemas_client.show_schema("metadefs/tags")
